...
@interface iCocosNormalTabBarView ()

@property (nonatomic,weak) iCocosNormalTabBarButton *button;

@end

@implementation iCocosNormalTabBarView
...
{
    iCocosNormalTabBarButton *tabButton=[[iCocosNormalTabBarButton alloc]init];
    tabButton.item=item;
...
#pragma mark 按钮的点击事件
-(void)tabButtonClick:(iCocosNormalTabBarButton*)sender
{
...
-(void)layoutSubviews
{
    ...
    for(int i=0;i<count;i++){
        btnX=i*btnW;
        iCocosNormalTabBarButton *btn=self.subviews[i];
        btn.tag=i;
